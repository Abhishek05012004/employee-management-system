      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  id="name"
                  type="text"
                  className="block w-full pl-4 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 bg-white"
            ...
            {/* Department */}
            <div>
              <label htmlFor="department" className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1">
            ...
            {/* Position */}
            <div>
              <label htmlFor="position" className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1">
            ...
            <div>
              <label htmlFor="employeeId" className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1">
              ...
              <div className="relative">
                ...
                <input
                  id="employeeId"
                  type="text"
                  className="block w-full pl-4 pr-3 py-3 border border-gray-300 rounded-lg bg-gray-50 cursor-not-allowed text-gray-900"
