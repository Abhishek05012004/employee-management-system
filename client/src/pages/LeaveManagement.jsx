            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                ...
                <div className="relative z-30">
                  <label htmlFor="selectDate" className="absolute inset-y-0 left-0 pl-3 flex items-center z-10 cursor-pointer group">
                  ...
                  <DatePicker
                    ...
                    className="pl-10 pr-3 py-1.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 bg-white text-sm relative z-0 w-[160px]"
            ...
            <form onSubmit={handleSubmitLeave} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative z-20">
                  <label htmlFor="leaveStart" className="absolute inset-y-0 left-0 pl-3 flex items-center z-10 cursor-pointer group">
                  ...
                  <DatePicker
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 relative z-0"
              ...
              <div>
                ...
                <div className="relative z-10">
                  <label htmlFor="leaveEnd" className="absolute inset-y-0 left-0 pl-3 flex items-center z-10 cursor-pointer group">
                    <Calendar className="h-5 w-5 text-gray-400 group-hover:text-blue-500 transition-colors" />
                  </label>
                  <DatePicker
                    id="leaveEnd"
