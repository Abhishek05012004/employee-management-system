...
export default function AttendanceLogs() {
  ...
  const [filters, setFilters] = useState({
    date: "", // Will be set to today's date string
  })
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <div className="relative z-30">
              <label htmlFor="attendanceDate" className="absolute inset-y-0 left-0 pl-3 flex items-center z-10 cursor-pointer group">
              ...
              <DatePicker
                ...
                className="pl-10 pr-3 py-1.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 bg-white text-sm relative z-0 w-full"
                  ...
                  <tr key={log._id || index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="text-sm font-medium text-gray-900">
                        {log.workingHours ? formatDurationHours(log.workingHours) : "--"}
                      </span>
                    </td>
