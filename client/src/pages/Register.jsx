            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="appearance-none relative block w-full pl-4 pr-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className="appearance-none relative block w-full pl-4 pr-12 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    name="department"
                    required
                    className="appearance-none relative block w-full pl-4 pr-10 py-3 border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                  ...
                  Enter the unique Admin Code provided by your organization's administrator.
                </p>
              </div>
            </div>
